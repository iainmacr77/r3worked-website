            ...
            <div className="flex h-full flex-col">
              ...
              <div className="mb-6 flex items-end gap-3">
                <AnimatedPrice
                  target={299}
                  prefix="£"
                  className="text-[3.6rem] font-bold leading-[0.9] tracking-[-0.04em] text-[#161616]"
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-2">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="shrink-0 flex items-end text-[1.3rem] font-bold leading-none tracking-[-0.02em] text-[#161616]">
                +
                <AnimatedPrice
                  target={99}
                  prefix="£"
                  className="text-[1.3rem] font-bold leading-none tracking-[-0.02em] text-[#161616]"
                  accentClassName="text-[#C97C2E]"
                />
