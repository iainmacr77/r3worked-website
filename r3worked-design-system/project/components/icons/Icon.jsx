...
const PATHS = {
  ...
  "phone": <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.68 1.6l-.468.339a1 1 0 0 0-.316 1.222 14.9 14.9 0 0 0 6.296 6.407" />,
  "phone-missed": <><path d="m22 2-5 5" /><path d="m17 2 5 5" /><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.684 1.585l-.468.339a1 1 0 0 0-.372 1.293 14.9 14.9 0 0 0 6.29 6.29" /></>,
...
export function Icon({ name, size = 18, strokeWidth = 2, color = "currentColor", className, style }) {
