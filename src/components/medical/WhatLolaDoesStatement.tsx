...
const HEADLINE =
    "A quieter front desk. A smoother clinic.";
const SUBHEADLINE_PREFIX = "Lola takes bookings, reschedules, cancellations, and FAQs — ";
const SUBHEADLINE_HIGHLIGHT = "so reception can run the clinic";
const SUBHEADLINE_SUFFIX = ".";
...
export function WhatLolaDoesStatement() {
            ...
            <div className="relative mx-auto w-full max-w-7xl">
                <div className="rounded-[2rem] border border-white/12 bg-white/[0.03] p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_34px_70px_rgba(0,0,0,0.5)] backdrop-blur-sm md:p-10">
                    <p className="mb-4 inline-flex items-center gap-2 whitespace-nowrap font-jetbrains text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-white/60">
                        <span className="inline-block h-1.5 w-1.5 rounded-full bg-mint/80" aria-hidden />
