...
// Kept local so the phone field stays fast, dependency-free, and usable before
// any third-party scripts load. The list includes countries and commonly used
// territories with their international calling codes.
export const PHONE_COUNTRIES: PhoneCountry[] = [
  { code: "AF", name: "Afghanistan", dialCode: "+93" },
  { code: "AX", name: "Åland Islands", dialCode: "+358 18" },
  ...
  { code: "CX", name: "Christmas Island", dialCode: "+61 8" },
  { code: "CC", name: "Cocos (Keeling) Islands", dialCode: "+61 8" },
